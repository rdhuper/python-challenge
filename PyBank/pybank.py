...
with open(file_to_load) as revenue_data:
    ...
    for row in reader:
        ...
        total_revenue = total_revenue + int(row["Profit/Loss"])
       

        
        revenue_change = int(row["Profit/Loss"]) - prev_revenue
     

    
        prev_revenue = int(row["Profit/Loss"])
        ...
        revenue_changes.append(int(row["Profit/Loss"]))
